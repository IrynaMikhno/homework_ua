...
console.log("Максимальна вартість послуг:", services.maxPrice()); //результат: Загальна вартість послуг: 3100 грн; Мінімальна вартість послуг: 350 грн; Максимальна вартість послуг: 1000 грн
